...
const appCss = "/assets/styles-CvAVnsAv.css";
...
const $$splitComponentImporter$e = () => import("./login-D5yael-t.mjs");
...
const $$splitComponentImporter$d = () => import("../_app-B3sr0LkC.mjs");
const Route$d = createFileRoute("/_app")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./index-Bsg28pQk.mjs");
...
const $$splitComponentImporter$b = () => import("./settings-DESiK35f.mjs");
const Route$b = createFileRoute("/_app/settings")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$a = () => import("./regularizations-Dcr-diN3.mjs");
const Route$a = createFileRoute("/_app/regularizations")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$9 = () => import("./profile-BXHHk9D8.mjs");
...
const $$splitComponentImporter$8 = () => import("./notifications-D4RFQI4Z.mjs");
...
const $$splitComponentImporter$7 = () => import("./map-CzGON4gZ.mjs");
...
const $$splitComponentImporter$6 = () => import("./leads-COT2xW22.mjs");
...
const $$splitComponentImporter$5 = () => import("./hr-management-CpyHBFB4.mjs");
...
const $$splitComponentImporter$4 = () => import("./employees-CjKeckuW.mjs");
...
const $$splitComponentImporter$3 = () => import("./documents-jk1a1eTU.mjs");
...
const $$splitComponentImporter$2 = () => import("./dashboard-CQseGdzd.mjs");
...
const $$splitComponentImporter$1 = () => import("./attendance-BNwn6Vhg.mjs");
...
const $$splitComponentImporter = () => import("./analytics-NJgHpPmk.mjs");
...
const AppSettingsRoute = Route$b.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => AppRoute
});
const AppRegularizationsRoute = Route$a.update({
  id: "/regularizations",
