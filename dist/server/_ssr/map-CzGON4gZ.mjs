...
import { e as Users, p as ChevronLeft, X, q as LocateFixed, d as Map$1, R as RefreshCw, Z as Zap, r as ChevronRight, m as Search, C as Clock, s as MapPin, N as Navigation, t as ArrowLeft, E as Ellipsis, P as Play, u as List, v as Signal, w as Pause, x as SkipBack } from "../_libs/lucide-react.mjs";
      ...
      if (stopStart !== null) {
        ...
        if (durMs >= 5 * 60 * 1e3) {
          ...
          stops.push({
            id: `stop-${stopNum}`,
            number: stopNum,
            latitude: sorted[stopStart].latitude,
            longitude: sorted[stopStart].longitude,
            durationMs: durMs,
            arrivedAt: sorted[stopStart].recordedAt
          });
        }
        stopStart = null;
      }
...
function MapPage() {
  ...
  const [replaySpeed] = reactExports.useState(1);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col h-full -mx-4 sm:-mx-6 -mt-2 relative bg-gray-100 ${view === "trip" ? "" : "hidden"}`, style: {
      ...
      isReplaying && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-[220px] left-1/2 -translate-x-1/2 bg-[#1E3A5F] text-white rounded-full px-4 py-2 flex items-center gap-3 shadow-xl z-30", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
          setReplayIndex(0);
          setIsReplaying(true);
        }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SkipBack, { className: "w-4 h-4" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsReplaying(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pause, { className: "w-4 h-4" }) }),
