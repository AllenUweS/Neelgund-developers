    ...
    <div className="w-full max-w-sm p-8 space-y-6 bg-white rounded-[24px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-gray-100">
      <div className="text-center flex flex-col items-center">
        <div className="bg-white px-2 py-2 mb-2 w-full flex justify-center">
          <img src="/logo-v4.png?v=20260612" alt="Neelgund Developers" className="h-14 w-auto object-contain" />
        </div>
      ...
      <form className="space-y-8" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between">
          <a href="#" className="text-xs text-gray-500 hover:text-[#154D8C] font-medium transition">Forgot Password?</a>
        </div>
      ...
      <p className="text-center text-xs text-gray-500">
        Don't have an account? <a href="#" className="font-bold text-[#154D8C] hover:text-[#113a6a] transition">Sign Up</a>
      </p>
    </div>
  );
}
