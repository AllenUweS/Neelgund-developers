...
import { u as useAuth, a as useNavigate, t as toast } from "./router-kA0jnLqi.mjs";
...
function LoginForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm p-8 space-y-6 bg-white rounded-[24px] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3)] border border-gray-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center flex flex-col items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white px-2 py-2 mb-2 w-full flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/logo-v4.png?v=20260612", alt: "Neelgund Developers", className: "h-14 w-auto object-contain" }) }),
