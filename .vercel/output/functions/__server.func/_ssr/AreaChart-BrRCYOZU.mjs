...
import { a as clsx } from "./utils-BH6shBk-.mjs";
import { r as reactExports, V as React, R as getDefaultExportFromCjs, a2 as commonjsGlobal } from "./index.mjs";
const __iconNode$1 = [
  [
    "path",
    {
...
var adaptEventsOfChild = function adaptEventsOfChild2(props, data, index) {
  if (!isObject(props) || _typeof$L(props) !== "object") {
    return null;
  }
  var out = null;
