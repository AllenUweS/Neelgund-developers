...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Ein5rBtg.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-kA0jnLqi.mjs").then((n2) => n2.d),
    import("./start-D2gMPWBf.mjs"),
...
export {
  ...
  isRedirect as a,
  appendUniqueUserTags as a0,
  resolveManifestCssLink as a1,
  commonjsGlobal as a2,
  Outlet as a3,
  createMiddleware as a4,
  React$1 as a5,
  isNotFound as b,
  invariant as c,
  createServerEntry,
